...
namespace InStoreCollectionWebApi.Extensions
{
    ...
    public class EntityFrameworkBatchHandler : DefaultODataBatchHandler
    {
        ...
        /// <summary>
        /// Executes the batch request and associates a <see cref="InStoreCollectionEntities"/>instance with all the requests of 
            ...
            CancellationToken cancellation)
        {
            ...
            using (InStoreCollectionEntities context = new InStoreCollectionEntities())
            {
