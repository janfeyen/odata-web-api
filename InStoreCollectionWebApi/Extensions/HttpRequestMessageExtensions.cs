...
namespace InStoreCollectionWebApi.Extensions
{
    /// <summary>
    ...
    public static class HttpRequestMessageExtensions
    {
        ...
        public static void SetContext(
            ...
            InStoreCollectionEntities context)
        {
        ...
        public static InStoreCollectionEntities GetContext(this HttpRequestMessage request)
        {
            object customersContext;
            if (request.Properties.TryGetValue(DB_Context, out customersContext))
            {
                return (InStoreCollectionEntities)customersContext;
            }
            else
            {
                InStoreCollectionEntities context = new InStoreCollectionEntities();
